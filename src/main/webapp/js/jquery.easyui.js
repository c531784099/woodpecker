...
(function ($) {
    ...
    function _215(_216, pp, _217) {
        pp.panel($.extend({}, _217, {collapsible: false, minimizable: false, maximizable: false, closable: false, doSize: false, tools: [
...
(function ($) {
    ...
    function _3fa(_446, _447) {
        ...
        var _448 = (_447 == true) ? (opts.frozenColumns || [
            []
        ]) : opts.columns;
        if (_448.length == 0) {
            return [];
...
(function ($) {
    ...
    ], showGroup: false, groupField: "group", groupFormatter: function (_59a) {
        return _59a;
    }});
})(jQuery);
(function ($) {
